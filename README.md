# [Demo Dashboard- Free Bootstrap 4, React, React Hooks and Reactstrap UI Kit](https://demos.creative-tim.com/demo dashboard/#/index?ref=pkr-github-readme) ![version](https://img.shields.io/badge/version-1.3.2-blue.svg) [![GitHub issues open](https://img.shields.io/github/issues/creativetimofficial/demo dashboard.svg?maxAge=2592000)](https://github.com/creativetimofficial/demo dashboard/issues?q=is%3Aopen+is%3Aissue) [![GitHub issues closed](https://img.shields.io/github/issues-closed-raw/creativetimofficial/demo dashboard.svg?maxAge=2592000)](https://github.com/creativetimofficial/demo dashboard/issues?q=is%3Aissue+is%3Aclosed) [![Join the chat at https://gitter.im/NIT-dgp/General](https://badges.gitter.im/NIT-dgp/General.svg)](https://gitter.im/creative-tim-general/Lobby) [![Chat](https://img.shields.io/badge/chat-on%20discord-7289da.svg)](https://discord.gg/E4aHAQy)

![Paper Kit React](https://raw.githubusercontent.com/creativetimofficial/public-assets/master/demo dashboard/opt_pk_react_thumbnail.jpg)

Demo Dashboardis a free Bootstrap 4, React, React Hooks and Reactstrap UI Kit with pale colors, beautiful typography and thoughtful drawings. We've created it having paper and drawings in mind.
...
Demo Dashboardis built on top of Bootstrap 4 using React and Reactstrap, so it fully supports React Hooks.

### Bootstrap 4 support

Demo Dashboardis built on top of Bootstrap 4 using React and Reactstrap, so it fully supports them. Most of the elements from the framework are re-designed to resemble sheets of paper and color pastels. If the are elements that we have not touched, they will gracefully fall back to the Bootstrap 4 default.

### Examples

Demo Dashboardcontains some pages already designed and implemented. Here is the list with the pages available. We are also working on more example pages, that you will be able to access no matter the version you download.

- [Landing Page](https://demos.creative-tim.com/demo dashboard/#/landing-page?ref=pkr-github-readme)
- [Register](https://demos.creative-tim.com/demo dashboard/#/register-page?ref=pkr-github-readme)
- [Profile Page](https://demos.creative-tim.com/demo dashboard/#/profile-page?ref=pkr-github-readme)

Tutorial and components

Once you download the archive, you will be able find a tutorial page inside it explaining how to start using it. You can also check the [documentation online](https://demos.creative-tim.com/demo dashboard/#/documentation/introduction?ref=pkr-github-readme).
...
| HTML                                                                                                                                                                                                             | Angular                                                                                                                                                                                                                                | React                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [![Paper Kit 2 HTML](https://raw.githubusercontent.com/creativetimofficial/public-assets/master/paper-kit-2-html/opt_pk2_thumbnail.jpg)](https://www.creative-tim.com/product/paper-kit-2?ref=pkr-github-readme) | [![Paper Kit 2 Angular](https://raw.githubusercontent.com/creativetimofficial/public-assets/master/paper-kit-2-angular/opt_pk2_angular_thumbnail.jpg)](https://www.creative-tim.com/product/paper-kit-2-angular?ref=pkr-github-readme) | [![Paper Kit  React](https://raw.githubusercontent.com/creativetimofficial/public-assets/master/demo dashboard/opt_pk_react_thumbnail.jpg)](https://www.creative-tim.com/product/demo dashboard?ref=pkr-github-readme) |

| Register Page                                                                                                                                                                                                     | Landing Page                                                                                                                                                                                                   | Profile Page                                                                                                                                                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![Register Page](https://raw.githubusercontent.com/creativetimofficial/public-assets/master/demo dashboard/register.png)](https://demos.creative-tim.com/demo dashboard/#/register-page?ref=pkr-github-readme) | [![Landing Page](https://raw.githubusercontent.com/creativetimofficial/public-assets/master/demo dashboard/landing.png)](https://demos.creative-tim.com/demo dashboard/#/landing-page?ref=pkr-github-readme) | [![Profile Page](https://raw.githubusercontent.com/creativetimofficial/public-assets/master/demo dashboard/profile.png)](https://demos.creative-tim.com/demo dashboard/#/profile-page?ref=pkr-github-readme) |

[View More](https://demos.creative-tim.com/demo dashboard/#/index?ref=pkr-github-readme)
...
The documentation for the Demo Dashboardis hosted at our [website](https://demos.creative-tim.com/demo dashboard/#/documentation/introduction?ref=pkr-github-readme).
...
- Demo: <http://demos.creative-tim.com/demo dashboard/#/index?ref=pkr-github-readme>
- Download Page: <https://www.creative-tim.com/product/demo dashboard?ref=pkr-github-readme>
- Documentation: <https://demos.creative-tim.com/demo dashboard/#/documentation/introduction?ref=pkr-github-readme>
...
- Issues: [Github Issues Page](https://github.com/creativetimofficial/demo dashboard/issues)
